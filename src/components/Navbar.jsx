...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-6 left-0 w-full z-50 flex justify-center px-4">
      <nav className="bg-[#111111]/80 backdrop-blur-xl border border-white/10 rounded-full px-6 py-2 shadow-[0_10px_30px_rgba(0,0,0,0.8)] flex items-center justify-evenly w-full max-w-lg">
        ...
        {navLinks.map((link) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <span className="absolute -bottom-2 w-8 h-[3px] rounded-full bg-[var(--color-accent)] shadow-[0_0_8px_var(--color-accent)] transition-all"></span>
              )}
            </Link>
          )
        })}
