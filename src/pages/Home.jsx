...
const Home = () => {
  ...
  const socialLinks = [
    {
      id: 'btn-facebook',
      label: 'Facebook',
      href: 'https://www.facebook.com/share/1E5iTpyYpm/',
      icon: <FacebookIcon />,
      color: '#1877F2',
    ...
    },
    {
      id: 'btn-messenger',
      label: 'Messenger',
      href: 'https://m.me/juan.escobar.653248',
      icon: <MessengerIcon />,
      color: '#0099FF',
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4 w-full h-full max-w-2xl mx-auto">

      {/* Glassmorphism Container */}
      <div className="w-full relative rounded-[2.5rem] overflow-hidden border border-blue-500/20 bg-blue-950/20 backdrop-blur-md shadow-2xl hover:border-blue-400/40 hover:shadow-[0_0_30px_rgba(37,99,235,0.3)] transition-all duration-500 flex flex-col items-center justify-center pt-5 pb-7 px-6">
        ...
        {/* Logo — más grande */}
        <div className="relative w-64 md:w-80 lg:w-96 aspect-square mb-3 flex items-center justify-center group">
          ...
          <img
            ...
            className={`w-full h-full object-cover rounded-full relative z-10 transition-all duration-[2000ms] border-2 border-blue-500/40 ${
              isPlaying
                ? 'scale-105 shadow-[0_0_60px_rgba(37,99,235,0.8)] border-blue-400/80'
        ...
        {/* Título */}
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-sans font-black italic tracking-wide uppercase flex gap-2 md:gap-3 drop-shadow-xl text-center mt-1">
        ...
        <div className="flex items-center justify-center gap-5 z-10 w-full">
          {socialLinks.map((s) => (
            <a
              key={s.id}
              id={s.id}
            ...
            >
              ...
              <span className="text-[9px] font-bold uppercase tracking-widest" style={{ color: s.color, opacity: 0.85 }}>
                {s.label}
              </span>
            </a>
          ))}
